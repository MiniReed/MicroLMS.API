...
#nullable disable
#nullable restore
#line 2 "C:\Users\Макс\Desktop\MicroLMS.API\Blazor\Pages\Edit - Копировать.razor"
...
#nullable disable
#nullable restore
#line 4 "C:\Users\Макс\Desktop\MicroLMS.API\Blazor\Pages\Edit - Копировать.razor"
...
#nullable disable
#nullable restore
#line 5 "C:\Users\Макс\Desktop\MicroLMS.API\Blazor\Pages\Edit - Копировать.razor"
...
#nullable disable
#nullable restore
#line 6 "C:\Users\Макс\Desktop\MicroLMS.API\Blazor\Pages\Edit - Копировать.razor"
...
#nullable disable
    ...
    public partial class Edit___Копировать : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 37 "C:\Users\Макс\Desktop\MicroLMS.API\Blazor\Pages\Edit - Копировать.razor"
    ...
    public List<Lesson> les { get; set; }
    ...
    protected override async Task OnParametersSetAsync()
    {
        ...
        les = await Http.GetFromJsonAsync<List<Lesson>>
            ("https://localhost:44376/api/Disciplines/all/" + Id);
    }

    private async Task Addles()
    {
        var leson = new Lesson { Name="лес1", HourseQuantity=2, Type="type",Discipline=discipline};
        newName = "";
        await Http.PostAsJsonAsync("https://localhost:44376/api/Disciplines", discipline);

    }

    private async void DeleteDic(Lesson lesson)
    {
        les.Remove(lesson);
        await Http.DeleteAsync("https://localhost:44376/api/Disciplines/" + lesson.Id);
    }
